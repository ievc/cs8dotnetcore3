...
namespace WorkingWithTasks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // WriteLine("Started methods synchronously on one thread.");
            //MethodA();
            //MethodB();
            //MethodC();
            /*WriteLine("Started methods asynchronously on multiple threads.");
            ...
            WriteLine("Parsing the result of the task as an input into another.");
